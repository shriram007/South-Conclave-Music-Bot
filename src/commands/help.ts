...
export const helpCommand = {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        "Studio-grade audio streaming for Discord. Plays songs from **Spotify**, **Apple Music**, **YouTube Music**, **JioSaavn**, and **SoundCloud** with 300+ kbps targeted Opus quality.\n"
      )
      .addFields([
        {
        ...
        },
        {
          ...
          value:
            "Ask your server admin to edit your voice channel and drag the **Bitrate slider to the max** (up to 256k or 384k on boosted servers) to hear the full 300+ kbps master sound!",
        },
      ])
      .setFooter({
