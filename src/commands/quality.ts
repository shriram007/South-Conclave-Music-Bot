...
export const qualityCommand = {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        "To get **Apple Music / Spotify 300+ kbps playback quality** in Discord, both the **Audio Engine** and the **Discord Voice Channel** must be running at maximum bitrate."
      );
    ...
    embed.addFields([
      {
        ...
        value:
          "• **Codec:** Opus Stereo (48,000 Hz Native)\n" +
