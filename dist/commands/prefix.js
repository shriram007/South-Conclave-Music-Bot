...
export const prefixCommand = {
    data: new SlashCommandBuilder()
        ...
        .setMaxLength(5)
        .setRequired(true)))
        .addSubcommand((sub) => sub.setName("view").setDescription("View the current prefix for this server")),
    async execute(interaction) {
        ...
        if (sub === "set") {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`The server prefix for **${interaction.guild?.name}** has been set to: \`${newPrefix}\`\n\n` +
