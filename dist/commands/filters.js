...
export const filterCommand = {
    data: new SlashCommandBuilder()
        ...
        .setRequired(true)
        .addChoices({ name: "💎 Hi-Fi Studio (Audiophile Clarity & Sparkle)", value: "hifi" }, { name: "🔊 Bass Boost (Punchy Deep Low-End)", value: "bassboost" }, { name: "🎤 Vocal / Treble Boost (Crisp Highs)", value: "treble" }, { name: "🎧 8D Audio (Rotating Binaural Effect)", value: "8d" }, { name: "⚡ Nightcore (Fast Tempo & Pitch)", value: "nightcore" }, { name: "🌊 Vaporwave (Slowed & Relaxed)", value: "vaporwave" }, { name: "🔄 Reset to Flat / Pure Audio", value: "reset" })),
