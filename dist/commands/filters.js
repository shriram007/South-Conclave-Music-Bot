...
export const filterCommand = {
    data: new SlashCommandBuilder()
        ...
        .setRequired(true)
        .addChoices({ name: "💎 Hi-Fi Studio (Audiophile Clarity & Sparkle)", value: "hifi" }, { name: "🔊 Bass Boost (Punchy Deep Low-End)", value: "bassboost" }, { name: "💥 Nuclear Bass (Extreme Ear-Rattling Sub)", value: "nuclear" }, { name: "🎤 Vocal / Treble Boost (Crisp Highs)", value: "treble" }, { name: "🎧 8D Audio (Rotating Binaural Effect)", value: "8d" }, { name: "⚡ Nightcore (Fast Tempo & High Pitch)", value: "nightcore" }, { name: "🌊 Vaporwave (Slowed & Relaxed)", value: "vaporwave" }, { name: "🐿️ Chipmunk (Funny High-Pitched Vocals)", value: "chipmunk" }, { name: "👺 Darth Vader / Demon (Deep Voice Shift)", value: "darthvader" }, { name: "🚪 Next Room / Party in the Hallway (Muffled)", value: "muffled" }, { name: "☎️ 1920s Old Radio / Telephone", value: "radio" }, { name: "🤿 Underwater (Submerged Bubbly Tone)", value: "underwater" }, { name: "🎤 Karaoke (Vocal Reducer / Sing-Along)", value: "karaoke" }, { name: "🤖 Robot / Synth (Metallic Ring Modulator)", value: "robot" }, { name: "🌀 Drunk / Dizzy (Psychedelic Pitch Wobble)", value: "wobbly" }, { name: "📢 Megaphone (Loud Street PA Speaker)", value: "megaphone" }, { name: "🏎️ Turbo Rush (1.35x High Energy Tempo)", value: "turbo" }, { name: "🔄 Reset to Flat / Pure Audio", value: "reset" })),
